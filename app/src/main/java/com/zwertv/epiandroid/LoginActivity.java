...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mLogInButton = (Button) findViewById(R.id.login_log_in_button);
    ...
    private boolean isLoginValid(String login) { return login.contains("_"); }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                isLogged = user.login(mLogin, mPassword);
        ...
        protected void onCancelled() {
            mLoginView.setError("Erreur de connexion");
            mAuthTask = null;
            showProgress(false);
        }
    }
